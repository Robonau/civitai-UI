<svg class="h-8" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 107 22.7">
	<g class="hidden sm:block">
		<path class="IconGrey" d="M20.8,1.7H3.7L1.5,4.1v15l2.3,2.3h17.1v-5.2H6.7V7h14.1V1.7z" />
		<path
			class="IconGrey"
		...
		/>
		<path class="IconBlue" d="M46.7,16.2v5.1h-5.1" />
	</g>
	<g class="sm:hidden">
		<linearGradient
			id="innerGradient"
